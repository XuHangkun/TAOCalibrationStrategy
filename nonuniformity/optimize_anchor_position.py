...
ideal_nu_map = TaoNuMap(mapinfo,kind="linear")
...
optimize_info = optimizer.scan_anchor_params(num=1000)
...
info_file = open(args.best_anchor_position_file,"w")
json.dump(best_anchor_info,info_file,indent=4)
info_file.close()
